...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_model', type=str, default='/mnt/harddisk3/Pengxiaolong/codespace/FAPNet-main/output/')
    
    parser.add_argument('--train_img_dir', type=str, default='/mnt/datasets/COD/Dataset/TrainDataset/Imgs/')
    parser.add_argument('--train_gt_dir',  type=str, default='/mnt/datasets/COD/Dataset/TrainDataset/GT/')
    parser.add_argument('--train_eg_dir',  type=str, default='/mnt/datasets/COD/Dataset/TrainDataset/Edge/')
    
    parser.add_argument('--test_img_dir',  type=str, default='/mnt/datasets/COD/Dataset/TestDataset/CAMO/Imgs/')
    parser.add_argument('--test_gt_dir',   type=str, default='/mnt/datasets/COD/Dataset/TestDataset/CAMO/GT/')
    parser.add_argument('--test_eg_dir',   type=str, default='/mnt/datasets/COD/Dataset/TestDataset/CAMO/Edge/')
